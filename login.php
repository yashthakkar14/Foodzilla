                    ...
                    <div class="card-body">
                        ...
                        <form class="form-signin" autocomplete="off">
                            ...
                            <div class="form-label-group">
                                <input autocomplete="false" type="email" id="inputEmail" name="user"
                        ...
                        <button id="signin" type="submit" onclick="a()"
                            class="btn btn-lg btn-signin btn-block text-uppercase"><i
                                class="fas fa-sign-in-alt mr-2"></i>Sign in</button>
                        <button class="btn btn-lg btn-google btn-block text-uppercase" onclick="b()"><i
