            ...
            <div class="container-fluid">
                    ...
                    <div class="col-12 col-md-10 col-lg-8">
                        <form class="card card-sm" action="./search.php">
                            <div class="card-body row no-gutters align-items-center">
                                ...
                                <div class="col">
                                    <input class="form-control form-control-lg form-control-borderless" type="search" name="query" id="dataentry" placeholder="Enter ingredient or recipe name">
                                </div>
                ...
                if (isset($_GET["query"]) && $_GET["query"] != "") {
                    ...
                    $querydat = "
                                ...
                                ";
                    $result = mysqli_query($connect, $querydat);
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            <div class="col-12 col-md-10 col-lg-10">
                                <div class="search-result p-2">
                                    ...
                                    <a href="./recipe.php?id=1" class="navbar-brand ml-3">' . $row["name"] . '</a>
                                </div>
                            </div>
                            </div>
                            </div>';
