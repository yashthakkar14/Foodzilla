            ...
            <div class="container-fluid">
                ...
                <div class="row ml-3 mb-4">
                    <div class="col-12 col-md-10 col-lg-8">
                        <form class="card card-sm" action="./search.php">
                            <div class="card-body row no-gutters align-items-center">
                                <div class="col-auto">
                                    <i class="fas fa-search h4 text-body"></i>
                                </div>
                                <div class="col">
                                    <input class="form-control form-control-lg form-control-borderless" type="search" name="query" placeholder="Enter ingredient or recipe name">
                                </div>
                ...
                if (isset($_GET["query"]) && $_GET["query"] != "") {
                    ...
                    // Write the search result code here

                    for ($i = 0; $i < 6; $i++) {
                        echo '<div class="row ml-3 mb-4">
                    <div class="col-12 col-md-10 col-lg-10">
                        <div class="search-result p-2">
                            <a href="./recipe.php?id=1" class="navbar-brand ml-3">' . $query . '</a>
                            <p class="ml-3">Ingredients of the recipe</p>
                        </div>
                    </div>
                    </div>';
                    }
